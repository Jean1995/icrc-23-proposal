  ...
  \begin{columns}[onlytextwidth]%
    ...
    \begin{column}{0.45\textwidth}%
      \begin{block}[equal height group=F, left=-5mm, right=-5mm, lefttitle=4mm, top=-5mm, bottom=-5mm]{Application: CORSIKA 8}%
        ...
        \centering
        \node [anchor=west, align=center] (noteA) at (2.5,12.3) {PROPOSAL is used to simulate the \\electromagnetic and muonic shower \\component in the new particle-shower\\ simulation code CORSIKA~8};
