...
plt.yscale('log')
plt.grid()
plt.ylabel(r'$\sigma \cdot E \,/\, \si{\mega\electronvolt\centi\meter\squared\per\gram} $', fontsize=8)
plt.xlabel(r'$E / \si{\peta\electronvolt}$', fontsize=8)


plt.savefig('lpm_cross_photopair_small.pdf', bbox_inches='tight')
