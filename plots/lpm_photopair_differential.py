...
plt.plot(x_list, np.vectorize(param_no_lpm.differential_crosssection)(particle, target, E, x_list), color='tab:red', linestyle='dashed', label='No LPM (all energies)')
...
plt.yscale('log')
plt.grid()
plt.ylabel(r'$\frac{\mathrm{d}\sigma}{\mathrm{d}x} \,/\, \frac{\mathrm{cm}^2}{\mathrm{g}} $', fontsize=10)
plt.xlabel(r'$x$', fontsize=10)


plt.savefig('lpm_photopair_differential.pdf', bbox_inches='tight')